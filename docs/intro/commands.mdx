...
- `save <name>;load <name>;` - Used for [save glitch](/tricks/save-glitch) and other things.
...
perform a large number of tricks, including [save glitch](/tricks/save-glitch), [bsg](/tricks/bsg), and
various others.
