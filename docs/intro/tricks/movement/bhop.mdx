...
The science behind bhopping is simple. When you jump, you become airborn, allowing you to air strafe. When you air strafe, you also gain
speed. When you continuously jump and strafe at the same time, you average more speed over time than just walking.
The goal of bhopping is to gain as much speed as possible, and to keep that speed for as long as possible. To
...
<iframe style={{width: "100%",aspectRatio: "16 / 9"}} src="https://www.youtube.com/embed/X3hrhsitmLo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<iframe style={{width: "100%",aspectRatio: "16 / 9"}} src="https://www.youtube.com/embed/B4ERwIShNWU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

### Double Strafe

The highest level of bhopping is to double strafe. This is when you strafe in one direction, then strafe in the opposite
direction, all within a single jump. This is the fastest way to bhop, but it is also the most difficult. It takes a lot
of practice to be able to double strafe consistently, and if done poorly, will be slower than single strafing. This is
typically done at a higher level of play, and is not recommended for beginners.

<iframe style={{width: "100%",aspectRatio: "16 / 9"}} src="https://www.youtube.com/embed/kxZDewYK_zc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>