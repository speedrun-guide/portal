...
[save glitch](/intro/tricks/save-glitch) and [bsg](/intro/tricks/bsg).

### Commands

All commands outside the [whitelist](/intro/commands#commands) are banned, unless explicitly allowed in a category's rules.
