...
You are allowed to skip the intro vault waiting sequence by using the [vault save](/intro/resources/saves#vault_save).
...
everything exactly as it should be timed. You can find a guide on how to set up LiveSplit [here](/intro/resources/livesplit).
...
To learn more about the console and allowed commands, check out the [commands page](/intro/commands).
