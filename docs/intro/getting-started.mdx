...
<Tabs defaultValue="5135">
    ...
    <TabItem value="3420" label="3420">
        This version of Source Unpack contains the 3420 build of the game. It is recommended that
...
It is highly recommended to use [LiveSplit](/intro/resources/livesplit), it comes with an auto splitter that times everything accurately,
including pauses.
...
Some keyboards may not have a tilda key. To get around this, you should add a bind for the command `toggleconsole` in your
[autoexec.cfg file]().
